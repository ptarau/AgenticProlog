...
public class Cat extends RankedGraph implements IFilter {
  ...
  */
  ...
  public void addVertex(Object vertex,Object data) {
    // Interact.errmes("error directly adding vertex in Cat:"+v+":"+data);
    setProp(vertex,"data",data);
  }
  
  public void addEdge(Object from,Object to,Object data) {
    // Interact.errmes("error directly adding edge in Cat:"+from+"=>"+to+":"+data);
  ...
  /**
  * Write out this Cat as graphviz DOT file.
  */
  public void to_dot(String fileName,int verboseVs,int verboseEs)
      throws Exception {
    walk(new CatDotWriter(fileName,verboseVs,verboseEs));
  }
  ...
  */
  ...
  public Object addTermTree(Term O,ObjectDict shared,int ftype,int ctype,
      int level) {
    Object S=shared.get(O);
    if(S!=null)
      return S;
